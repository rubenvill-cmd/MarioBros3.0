...
public class Mario extends MovingObject{
	...
	public Mario(Mario other) { //Constructora que devuelve una copia del Mario leído en la file.
		super(other);
	...
	public Mario parse(String[] objectDescription, GameWorld game) throws GameParseException, OffBoardException {
		...
		if (go!= null) {
			...
			if (objectDescription.length == 4) {
				...
				else throw new GameParseException(Messages.INVALID_MARIO_SIZE.formatted(String.join(" ", objectDescription))); //INVALID MARIO SIZEE
			}
